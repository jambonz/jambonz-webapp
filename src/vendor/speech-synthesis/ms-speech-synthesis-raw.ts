import type { MSRawSpeech } from "../types";

export const rawData: MSRawSpeech[] = [
  {
  ...
  {
    Name: "Microsoft Server Speech Text to Speech Voice (de-DE, SeraphinaNeural)",
  ...
  {
    Name: "Microsoft Server Speech Text to Speech Voice (en-US, JennyMultilingualV2Neural)",
  ...
  {
    Name: "Microsoft Server Speech Text to Speech Voice (fr-FR, VivienneNeural)",
